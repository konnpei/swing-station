...
```json
{
  ...
  "sox_pct": -7.0,
  "vix": 17.9,
  "news": [{"tag": "警戒", "headline": "見出し", "body": "本文"}],
  "stocks_jp": [{
    "name": "トヨタ", "code": "7203", "pattern": "暴落リバウンド",
    "score": 8, "entry": "MA25付近", "target": "+3%", "stop": "-2%",
    "reason": "根拠", "comment": "一言"
  }],
  "stock_us": {
    "name": "BRK.B", "ticker": "$BRK.B", "pattern": "バフェット式",
    "score": 8, "entry": "MA50付近", "target": "+3%", "stop": "-2%",
    "reason": "根拠", "comment": "一言"
  },
  "consideration": {"main": "考察", "point": "重要点", "action": "アクション"},
  "x_main": "X投稿文",
  "note_cta": "CTA文"
}
```

## バナー画像（public/banners/）
- /banners/normal.png
- /banners/surge.png  
- /banners/crash.png
- /banners/ai.png
...
## リンク
- note: https://note.com/kabubocchi
- X: https://x.com/kabubocchi
- Discord: 後で追加
